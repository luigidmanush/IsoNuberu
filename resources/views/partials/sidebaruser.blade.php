<ul id="sidebarnav" class="in">
        <li class="nav-small-cap">{{ $User->name }} - {{ $User->nombre }}</li>
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Manual y Politicas</a>
            <ul aria-expanded="false" class="collapse" style="height: 0px;">
                <li><a href="/procedimiento/{{ $val=1 }}">Manual de Gestión</a></li>
                <li><a href="index2.html">Política Ambiental</a></li>
                <li><a href="index3.html">Política de Prevención</a></li>
            </ul>
        </li>
        <li>
